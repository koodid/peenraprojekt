...
def nelinurkpeenar():
    ...
    def algandmed():
        # Mõõtude paremaks tajumiseks joonistatakse peenrale ruudustik (0,5m sammuga).
        ...
        if kylg1_kasutaja == '' or kylg2_kasutaja == '':
            ...
            try:
                ...
                if kylg1 >= 1 and kylg1 <= 10 and kylg2 >= 1 and kylg2 <= 10:
                    ...
                    valisaar_nelinurkpeenar(x_algus, y_algus, x_kylg1, y_kylg1, x_kylg2, y_kylg2, x_lopp, y_lopp)
                    ...
                    Button(frame_alus,
                           ...
                           command =  peenraplaan_nelinurkpeenar,
    ...
    def valisaar_nelinurkpeenar(x0, y0, x1, y1, x2, y2, x3, y3):
        # Nelinurga nurgakoordinaadid on järjestatud päripäeva. Sellest lähtuvalt on ka küljed vastavalt järjestatud.
        joon1_id = tahvel.create_line(x0, y0, x1, y1, width=4, activefill = 'grey', tags = 'peenar')
        joon2_id = tahvel.create_line(x1, y1, x2, y2, width=4, activefill = 'grey', tags = 'peenar')
        joon3_id = tahvel.create_line(x2, y2, x3, y3, width=4, activefill = 'grey', tags = 'peenar')
        joon4_id = tahvel.create_line(x3, y3, x0, y0, width=4, activefill = 'grey', tags = 'peenar')
        ...
        def joone_markimine2(event):
            joon2_id = tahvel.create_line(x1, y1, x2, y2, width=4, fill = 'red', tags = 'peenar')
            loenda_vaade_kylg2()

        def joone_markimine3(event):
            joon3_id = tahvel.create_line(x2, y2, x3, y3, width=4, fill = 'red', tags = 'peenar')
            loenda_vaade_kylg3()

        def joone_markimine4(event):
            joon4_id = tahvel.create_line(x3, y3, x0, y0, width=4, fill = 'red', tags = 'peenar')
            loenda_vaade_kylg4()
        ...
        tahvel.tag_bind(joon4_id, '<1>', joone_markimine4)
    ...
    def kujundussoovitused(kylg1, kylg2):
        ...
        if kaugus < 2:
            korge_peenar = 0.6
        elif vaade_kylg1 == vaade_kylg2 == 1 or vaade_kylg1 == vaade_kylg4 == 1 or vaade_kylg3 == vaade_kylg2 == 1 or vaade_kylg3 == vaade_kylg4 == 1:
            # Nurga pealt on "pikimaks küljeks" peenra diagonaal.
            diagonaal = (kylg1**2 + kylg2**2)**0.5
            if kaugus < diagonaal:
                korge_peenar = kaugus
            else:
                korge_peenar = diagonaal
        elif vaade_kylg1 == 1 or vaade_kylg3 == 1:
            if kaugus < kylg1:
                korge_peenar = kaugus
            else:
                korge_peenar = kylg1
        elif vaade_kylg2 == 1 or vaade_kylg4 == 1:
            if kaugus < kylg2:
                korge_peenar = kaugus
            else:
                korge_peenar = kylg2
    ...
    def peenraplaan_nelinurkpeenar():
        ...
        def nurgapeenra_pealtvaade(x0, y0, x1, y1, x2, y2, x3, y3, varv, taht, xA, peenra_korgus):
            ...
            tsoon_id = tahvel.create_text(x0 + 10, y0 + 15, text = chr(taht_uus), font = alapealkiri_font, fill = 'snow', anchor=W, tags = 'peenar')
            ...
            if vaade_kylg1 == vaade_kylg2 == vaade_kylg3 == vaade_kylg4:
                x0_uus = x0 + (x1)*1/5
                y0_uus = y0 + (y2)*1/5
                x1_uus = x1 - (x1)*1/5
                y1_uus = y0_uus
            ...
            elif vaade_kylg1 == vaade_kylg2 == vaade_kylg3 == 1:
                x0_uus = x0
                y0_uus = y0 + (y2)*1/5
                x1_uus = x1 - (x1)*1/5
                y1_uus = y0_uus
            ...
            elif vaade_kylg2 == vaade_kylg3 == vaade_kylg4 == 1:
                x0_uus = x0 + (x1)*1/5
                y0_uus = y0
                x1_uus = x1 - (x1)*1/5
                y1_uus = y1
            ...
            elif vaade_kylg3 == vaade_kylg4 == vaade_kylg1 == 1:
                x0_uus = x0 + (x1)*1/5
                y0_uus = y0 + (y2)*1/5
                x1_uus = x1
                y1_uus = y0_uus
            ...
            elif vaade_kylg4 == vaade_kylg1 == vaade_kylg2 == 1:
                x0_uus = x0 + (x1)*1/5
                y0_uus = y0 + (y2)*1/5
                x1_uus = x1 - (x1)*1/5
                y1_uus = y0_uus
                ...
                tsoon_id2 = tahvel.create_text(x1 - 10, y1 + 15, text = chr(taht_uus), font = alapealkiri_font, fill = 'snow', anchor=E, tags = 'peenar')

            elif vaade_kylg3 == vaade_kylg4 == 1:
                x0_uus = x0 + (x1)*1/5
                y0_uus = y0
                x1_uus = x1
                y1_uus = y1
            ...
            elif vaade_kylg4 == vaade_kylg1 == 1:
                x0_uus = x0 + (x1)*1/5
                y0_uus = y0 + (y2)*1/5
                x1_uus = x1
                y1_uus = y0_uus
            ...
            elif vaade_kylg2 == vaade_kylg4 == 1:
                x0_uus = x0 + (x1)*1/5
                y0_uus = y0
                x1_uus = x1 - (x1)*1/5
                y1_uus = y1
                ...
                y3_uus = y2_uus
                tahvel.delete(tsoon_id)
                tsoon_id2 = tahvel.create_text(x0 + 10, y2 - 15, text = chr(taht_uus), font = alapealkiri_font, fill = 'snow', anchor=W, tags = 'peenar')
            ...
            nurgapeenra_pealtvaade(x0_uus, y0_uus, x1_uus, y1_uus, x2_uus, y2_uus, x3_uus, y3_uus, varv_uus, taht_uus, xA_uus, peenra_korgus)
            ruudustik(laius, korgus)
            
        # Järjendid rekursiooni käigus tekkivate andmete kogumiseks ja säilitamiseks.
        peenra_korgused = []
        tsoonide_tahed = []
        nurgapeenra_pealtvaade(x_algus, y_algus, x_kylg1, y_kylg1, x_kylg2, y_kylg2, x_lopp, y_lopp, (195, 253, 51), 64, x_algus - 250, korge_peenar)

        # Peenra korguste lisamine tahvli ülaääres olevate tsoonide tähtede juurde.
    ...
    # Tühjale tahvlile kohe vajaliku kõrguse andmiseks on raami paigutatud ka tühjad read.
    tyhjad_read(28)
    ...
    Label(frame_alus, text = 'Sisesta üks peenrakülje pikkus (max 10 meetrit):',
          justify = RIGHT, font = tavakiri_font, bg = 'snow').grid(row=0, column=0, sticky=E)
    Label(frame_alus, text = 'Sisesta teine peenrakülje pikkus (max 10 meetrit):',
